#ifndef BOOST_ATOMIC_DETAIL_ATOMIC_LINUX_ARM_HPP
#define BOOST_ATOMIC_DETAIL_ATOMIC_LINUX_ARM_HPP
...
public:
	...
	bool compare_exchange_strong(
		...
		if (!success) e = load(memory_order2_relaxed);
		return success;
	}
	...
	T exchange(T replacement, memory_order2 order=memory_order2_seq_cst) volatile
	{
		// Copied from build_exchange.
                T o=load(memory_order2_relaxed);
