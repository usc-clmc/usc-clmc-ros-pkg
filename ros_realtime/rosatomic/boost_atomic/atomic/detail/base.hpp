#ifndef BOOST_ATOMIC_DETAIL_ATOMIC_BASE_HPP
#define BOOST_ATOMIC_DETAIL_ATOMIC_BASE_HPP
...
static inline memory_order2 calculate_failure_order(memory_order2 order)
{
	switch(order) {
		case memory_order2_acq_rel: return memory_order2_acquire;
		case memory_order2_release: return memory_order2_relaxed;
