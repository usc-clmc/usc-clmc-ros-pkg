...
bool Parse_log(Data_loader &data_loader, Data_storage &data_storage,
	...
	if (!data_loader.Load_supervised_from_grasp_analysis(path_bagfile, "/analyzed_grasp_data",
...
int main(int argc, char** argv) {
	const std::string ROS_NH_NAME_SPACE = "main_grasp_data_supervised_grasp_analysis";
