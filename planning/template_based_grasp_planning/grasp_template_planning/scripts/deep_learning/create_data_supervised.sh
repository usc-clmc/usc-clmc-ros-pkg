...
./scripts/deep_learning/dataset_template_supervised_grasping.py --dir-path-source data/deep_learning/grasp-database/ --dir-path-destination data/deep_learning/grasp-database/ --file-name arm-grasp-dataset --fast False
