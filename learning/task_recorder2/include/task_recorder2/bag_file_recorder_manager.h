...
#include <task_recorder2/bag_file_recorder.h>
#include <task_recorder2/bag_file_recorder_client.h>
...
private:
  ...
  bool initialized_;
  std::vector<boost::shared_ptr<task_recorder2::BagFileRecorderBase> > clients_;
