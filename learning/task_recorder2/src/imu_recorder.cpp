...
std::vector<std::string> ImuRecorder::getNames() const
{
  ...
  names.push_back(std::string("imu_qw"));
  names.push_back(std::string("imu_qx"));
  names.push_back(std::string("imu_qy"));
  names.push_back(std::string("imu_qz"));
  names.push_back(std::string("imu_angular_vel_x"));
  names.push_back(std::string("imu_angular_vel_y"));
  names.push_back(std::string("imu_angular_vel_z"));
  names.push_back(std::string("imu_linear_acc_x"));
  names.push_back(std::string("imu_linear_acc_y"));
  names.push_back(std::string("imu_linear_acc_z"));
  return names;
}
