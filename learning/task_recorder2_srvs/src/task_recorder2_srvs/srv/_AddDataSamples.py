"""autogenerated by genpy from task_recorder2_srvs/AddDataSamplesRequest.msg. Do not edit."""
import sys
...
task_recorder2_msgs/DataSample[] data_samples
...
"""
  __slots__ = ['description','data_samples']
  _slot_types = ['task_recorder2_msgs/Description','task_recorder2_msgs/DataSample[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AddDataSamplesRequest, self).__init__(*args, **kwds)
...
_struct_2I = struct.Struct("<2I")
"""autogenerated by genpy from task_recorder2_srvs/AddDataSamplesResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class AddDataSamplesResponse(genpy.Message):
  _md5sum = "08e818d11b8a1784db18a2ff26ef20f5"
  _type = "task_recorder2_srvs/AddDataSamplesResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AddDataSamplesResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
