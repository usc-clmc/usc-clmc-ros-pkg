...
inline bool getSVMLabel(const task_recorder2_msgs::DataSampleLabel& label, double& value)
{
  ...
  if (label.binary_label.label == task_recorder2_msgs::BinaryLabel::SUCCEEDED || label.binary_label.label == task_recorder2_msgs::BinaryLabel::FAILED)
  {
    value = (double)label.binary_label.label;
  }
  else
  {
